   ...
   public class DataSqlDAO:IData
    {
        ...
        public void AddUser(Users user)
        {
            ...
            using (var command = new SqlCommand())
            {
                ...
                var returnParametr = command.Parameters.Add("@returnVal", SqlDbType.Int);
                ...
                /*var result=*/
                 command.ExecuteScalar();
                                                    //       не могу получить ID из таблицы
                ...
                var result = returnParametr.Value;
        ...
        public IEnumerable<Awards> GetAwardList()
        {
            ...
            using (var command = new SqlCommand())
            {
                ...
                var reader = command.ExecuteReader(); 
                if (reader.HasRows)  //ничего не получает. всегда false
                {
                    while (reader.Read())
                    {
